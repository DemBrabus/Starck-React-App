...
import './Series1Adjustability.scss';

export default function Series1Adjustability() {
    return (
        <div className='Series1Adjustability'>
            <div className='Series1Adjustability-Wrapper'>

                <div className='Series1Adjustability-Image'></div>
