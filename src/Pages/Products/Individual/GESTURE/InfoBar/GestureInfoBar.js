                ...
                <div className={ImagesCardClasses}>
                    <div className='InfoBar-ImagesCard-Wrapper'>
                        <div className='InfoBar-ImagesCard-Row'>
                            <div className='InfoBar-ImagesCard-Image GestureInfoBar-ImagesCard-Image1'></div>
                            <div className='InfoBar-ImagesCard-Image GestureInfoBar-ImagesCard-Image2'></div>
                            <div className='InfoBar-ImagesCard-Image GestureInfoBar-ImagesCard-Image3'></div>
                            <div className='InfoBar-ImagesCard-Image GestureInfoBar-ImagesCard-Image4'></div>
                        </div>
                        <div className='InfoBar-ImagesCard-Row'>
                            <div className='InfoBar-ImagesCard-Image GestureInfoBar-ImagesCard-Image5'></div>
                            <div className='InfoBar-ImagesCard-Image GestureInfoBar-ImagesCard-Image6'></div>
                            <div className='InfoBar-ImagesCard-Image GestureInfoBar-ImagesCard-Image7'></div>
                            <div className='InfoBar-ImagesCard-Image GestureInfoBar-ImagesCard-Image8'></div>
                        </div>
                    </div>
                </div>
